...
0. Install Homebrew, then install Qt5, Ruby 3.2, and Python 3.11 by
```
$ brew install qt@5
...
$ ./python3HB.py -v 3.11
```
1. Invoke **`build4mac.py`** with the following options: **((Notes))** These options are the default for Monterey, Ventura, and Sonoma.
```
$ cd /where/'build.sh'/exists
...
0. Install Homebrew, then install Qt5 and Python 3.11 by
```
$ brew install qt@5
$ brew install python@3.11
$ cd /where/'build.sh'/exists
...
0. Install MacPorts, then install Qt5, Ruby 3.2, and Python 3.11 by
```
...
0. Install Anaconda3 (Anaconda3-2023.09-0-MacOSX-x86_64.pkg), then install Ruby 3.1 by
```
